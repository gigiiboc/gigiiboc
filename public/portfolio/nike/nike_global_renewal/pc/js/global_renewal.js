$(function(){
	...
	globalSel.on('click', function(e){
		if ($(this).hasClass(globalAct)) {
			...
			$(this).parent('.global_sect_menu').removeClass('active');
		}else {
			$(this).addClass(globalAct).next().show();
			$(this).parent('.global_sect_menu').addClass('active');
		}
		e.preventDefault();
		e.stopPropagation();
	...
	$('.global_sect_menu_list a').on('click', function(e){
		$(this).parents('.global_sect_menu').removeClass('active');
		$(this).parent().addClass('active').siblings().removeClass('active');
		$(this).parents('.global_sect_menu').find('.global_sect_field span').text($(this).text());
	});

	$('body').click('on',function(){
		if (globalSel.hasClass(globalAct) && globalSel.length) {
			globalSel.removeClass(globalAct).next().hide();
			$('.global_sect_menu').removeClass('active');
		}
	});
