...
<body>
	<style>
		...
		.pdt_con .sec3 .video_section .play_btn {display:none;position: absolute;left:0;top:0;width:100%;height:100%;background:url(/note/aestura_scroll_animation/images/pdt_sec03_video.jpg) no-repeat center;}
		...
		.pdt_con .sec3 .video_section .thumb {position: absolute;left:0;top:0;width:100%;height:100%;background:url(/note/aestura_scroll_animation/images/pdt_sec03_video.jpg) no-repeat center;}
		...
		.pdt_con .sec4 .bg {display:block;position:absolute;right:0;bottom:0;width:100%;height:100%;background: url(/note/aestura_scroll_animation/images/pdt_sec04_bg01_test.png) repeat;filter:alpha(opacity:'5');-webkit-transition: .5s ease-in;transition: .5s ease-in;-webkit-opacity:0.05;opacity:0.05;}
		.pdt_con .sec4 .bg2 {display:block;position:absolute;right:0;bottom:0;width:460px;height:796px;background: url(/note/aestura_scroll_animation/images/pdt_sec04_bg02.png) no-repeat right bottom;-webkit-transition: .5s ease-in;transition: .5s ease-in}
		.pdt_con .sec4 .ctt {display:block;width: 100%;height: 100%;margin: 0 auto;background: url(/note/aestura_scroll_animation/images/pdt_sec04_ctt.png) no-repeat center;z-index: 1;-webkit-transition: 0.8s ease-out;transition: 0.8s ease-out}
		...
		.pdt_con .sec4.on .bg {background: url(/note/aestura_scroll_animation/images/pdt_sec04_bg01_test_on.png) repeat;filter:alpha(opacity:'10');-webkit-opacity:0.1;opacity:0.1;}
		.pdt_con .sec4.on .bg2 {background: url(/note/aestura_scroll_animation/images/pdt_sec04_bg02_on.png) no-repeat right bottom;}
		.pdt_con .sec4.on .ctt {background: url(/note/aestura_scroll_animation/images/pdt_sec04_ctt_on.png) no-repeat center;}
	</style>
	<div id="wrap">
		<div id="container">
			<div class="pdt_con">
				<div class="sec1">
					<img src="/note/resource/images/aestura/pdt_sec01_bg01.jpg" class="big _a viewAnim" anime-stlye="2" alt="">
					<img src="/note/resource/images/aestura/pdt_sec01_bg02.jpg" class="big _b viewAnim" anime-stlye="2" alt="">
					<img src="/note/resource/images/aestura/pdt_sec01_bg03.jpg" class="big _c viewAnim" anime-stlye="2" alt="">
				</div>		
				<div class="sec3">
					<ul>
						<li>
							<img src="/note/resource/images/aestura/pdt_sec03_txt01.png" class="_a viewAnim" anime-stlye="2" alt="건강한 피부장벽 강화를 위한 고보습 크림, 손상된 피부 장벽기능 강화에 도움을 주며, 건조함과 그로인한 가려움을 케어해주는 보습크림 입니다.">
							<img src="/note/resource/images/aestura/pdt_sec03_img01.gif" class="_b viewAnim" anime-stlye="2" alt="">
						</li>
						<li>
							<img src="/note/resource/images/aestura/pdt_sec03_txt02.png" class="_c viewAnim" anime-stlye="2" alt="피부 지질과 유사한 구조의 더마온(DermaON®)소프트 캡슐 기술이 피부속으로 깊게 흡수를 도와줍니다.">
							<img src="/note/resource/images/aestura/pdt_sec03_img02.png" class="_d viewAnim" anime-stlye="2" alt="">
						</li>
						<li>
							<img src="/note/resource/images/aestura/pdt_sec03_txt03.png" class="_e viewAnim" anime-stlye="2" alt="손상된 피부 장벽 기능을 강화시켜주는 밤 타입의 집중보습제">
							<img src="/note/resource/images/aestura/pdt_sec03_img03.png" class="_f viewAnim" anime-stlye="2" alt="">
						</li>
					</ul>
				</div>
