	...
	<div class="ytwrap">
		<div class="ytcon">
			<div class="playerCover">
				<a href="#none" onclick="playVOD(0,'wpbDubF2MR8');" class="btnPlay" style="display:block;position:absolute;left:0;top:0;width:100%;height:100%;background:url(./images/youtube1.jpg) no-repeat left top;background-size:100% auto;"></a>
			</div>
		...
		<div class="ytcon">
			<div class="playerCover">
				<a href="#none" onclick="playVOD(1,'wpbDubF2MR8');" class="btnPlay" style="display:block;position:absolute;left:0;top:0;width:100%;height:100%;background:url(./images/youtube2.jpg) no-repeat left top;background-size:100% auto;"></a>
			</div>
