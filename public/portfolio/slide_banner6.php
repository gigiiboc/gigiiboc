...
<head>
	...
	<style>
		...
		.blTvWrap{}
		.blTvWrap .blTvArea{position: relative;top:0;font-size: 0;line-height: 0;white-space: nowrap;}
		.blTvArea .blTvBox{position: relative;overflow: hidden;display: inline-block;width:300px;height:500px;}
...
<div id="wrap" class="h_main">
	...
	<div class="banilaTV">
		<div class="blTvWrap">
			<div class="blTvArea">
				<div class="blTvBox" style="background:#000;"></div>
				<div class="blTvBox" style="background:#222;"></div>
				<div class="blTvBox" style="background:#444;"></div>
				<div class="blTvBox" style="background:#666;"></div>
				<div class="blTvBox" style="background:#888;"></div>
			</div>
		</div>
	</div>
	<!-- container -->
	...
	<script>
		...
		function banila_tv_start(){
			$('.blTvArea').find('.blTvBox').css('width', tvCntWidth + 'px');
		...
		function nextVideo(){
			...
			$('.blTvArea').stop().animate({'left' : -tvCntWidth+'px'},300, function(){
				$('.blTvArea').css('left', '0px');
				$('.blTvArea .blTvBox:first-child').appendTo('.blTvArea')
			});
		}
		function prevVideo(){
			$('.blTvArea .blTvBox:last-child').prependTo('.blTvArea');
			$('.blTvArea').css('left', -tvCntWidth+'px').stop().animate({'left' : 0},300);
		...
		$(window).resize(function(){
			tvCntWidth = $('.blTvBox').width();
			$('.blTvArea .blTvBox').width(tvCntWidth)
			$('.blTvArea').css('left', '0px');
		})
