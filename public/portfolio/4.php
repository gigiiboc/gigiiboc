...
.popup_box {position:absolute; width:558px; height:330px; z-index:102; background:#fff; border:1px solid #d2d2d2; padding-top:10px}
</style>
</head>

<body>

<div id="all_popup" style="position:absolute; left:0; top:0; width:100%; height:100%; display:none">
 <div class="popupLayer"><div class="back"></div></div>
 
 <div style="position:absolute; top:20%; left:30%; z-index:101">
   <iframe id="layerf" src="" width="560" height="342" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
  </div>
</div>
