...
<body>
	...
	<div class="tip">
		<h2>IE버전 강제 변환용 메타태그</h2>
		<ul>
			<li>&lt;mate http-equiv="X-UA-Compatible" content="IE=7;"&gt;</li>
			<li>&lt;mate http-equiv="X-UA-Compatible" content="IE=8;"&gt;</li>
			<li>&lt;mate http-equiv="X-UA-Compatible" content="IE=9;"&gt;</li>
			<li>&lt;mate http-equiv="X-UA-Compatible" content="IE=dege;"&gt;</li>
		</ul>
		<p>
		<br>
		IE 를 = ? 의 브라우저로 강제 변환.<br>
		dege의 경우 최신 브라우저로 강제 변환.<br><br>		
		위 메타태그는 클라이언트가 기본브라우저 설정이 호환성모드이거나, <br>
		다른 IE버전에서 레이아웃이 깨져서 나오는 부분이 있을경우 <br>
		강제적으로 IE버전을 원하는 버전으로 변경하는 방법.
		</p>
	</div>
