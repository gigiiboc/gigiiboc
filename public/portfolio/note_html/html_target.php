...
<body>
	...
	<div class="tip">
		<h2>target 속성은 각 링크가 클릭되었을 때 새로운 페이지가 어디에 열리는지를 지정한다.</h2>
		<ul>
			<li>_blank : 새 창에서 연다.</li>
			<li>_self : 현재 창에서 연다.</li>
			<li>_parent : 부모 프레임에서 연다.</li>
			<li>_top : 현재 창에서 열고 모든 프레임을 취소한다.</li>
		</ul>
	</div>
