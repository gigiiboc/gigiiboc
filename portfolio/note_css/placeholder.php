...
<body>
<style>
input {display: inline-block;vertical-align: middle;padding: 5px 0;color: #111;font-size: 13px;letter-spacing: 0.5px;width: 70%;border: none;background: none;outline: none;}
input::-webkit-input-placeholder {color:#ccc;}
input::-moz-placeholder {color:#ccc;}
input::-ms-input-placeholder {color:#ccc;}
</style>
<div style="width:300px;margin:20% auto">
	<label for="accountNumber">계좌번호</label><input type="text" id="accountNumber" placeholder="계좌 번호를 숫자만 입력해 주세요.">
</div>
</body>
</html>
